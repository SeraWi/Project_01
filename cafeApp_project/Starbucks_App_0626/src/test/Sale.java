...
public class Sale {
	...
	private int price; // 가격 ( 한 번 주문한 가격, 예) 아메리카노 3잔 -> price = 아메리카노 가격 * 3)
	...
	//생성자 1- 추가 : SaleTable전체 리스트 가져올 때 회원 아이디 추가
	...
	//생성자 오버로딩 2-추가 : Sale DB에 저장하게 될 때 사용자 아이디도 같이 저장하기 
	...
	// 생성자 오버로딩 3 : saleBestManager에 쓸 수 있는 생성자/ 인기상품 조회를 위한 생성자
