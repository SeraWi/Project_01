...
public class Sale {
	...
	private int scount; // 주문한 메뉴 카운트 ( 주문내역과, 영수증에 사용) ex)아메리카노 3개 12000원
	...
	//생성자 1 : DB에서 전체 SaleTable가져올 때 사용 (가장 초기 버전)
	...
	//생성자 1-6/25일 발전사항 : SaleTable전체 리스트 가져올 때 회원 아이디 추가
