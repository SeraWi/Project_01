...
public class Sale {
	...
	private int scount; // 메뉴 판매 수 (추가)
	private int price; // 가격 = 메뉴 가격  * 갯수( 주문을 받은 한행의 총액 : 1 3 -> 아메리카노 가격 * 3개 = price) 
	...
	//생성자 오버로딩 2 : SaleDB에 저장하게 될 때 사용자 + 각 메뉴별 수량 추가(현우, 수량추가DB) / 영수증 출력에도 사용!
	...
	// 추가 21.06.25 -> 영수증에 갯수 정보 추가 하기 위해!
